...
export default function Sidemenu({visiblety}:{visiblety:ReactNode}) {
  ...
  return (
    <>
    <div className={`${visiblety?"visible":"hidden"} font-cursive text-sm items-center fixed top-[12%] left-[240px] h-[540px] w-[260px] transform -translate-x-1/2 bg-[#d2e3e6] shadow-2xl rounded-lg p-3 flex flex-col`}>
